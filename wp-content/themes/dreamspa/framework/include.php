...
require_once get_template_directory().'/framework/reservation-util.php';

require_once get_template_directory().'/framework/sociable_shortcodes.php';
...
#Theme Customizer
#require_once( get_template_directory().'/framework/theme_customizer.php');
