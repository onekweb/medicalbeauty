                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                      <ul class="bpanel-post-layout bpanel-layout-set"><?php 
                        $header_types = array("header1","header2","header3","header4");
                        foreach( $header_types as $header_type):
                          ...
                          <li class="headerlayout"><a href="#" rel="<?php echo $header_type;?>" <?php echo $class;?> title="<?php echo $header_type;?>">
                            <img src="<?php echo IAMD_FW_URL."theme_options/images/headers/{$header_type}.png";?>" /></a></li><?php 
                        endforeach; ?>
                      </ul>
            ...
            <div class="box-content">
              ...
              <div class="font-container">
                ...
                <div class="hr"></div><?php
                  ...
                  $show_menu_standard_font = ("on" == dttheme_option('appearance', 'menu-font-type')) ? " style='display:block;' " : "  style='display:none;' ";
                    ...
                    <div class="clear"></div>
                      ...
                      <div class="column one-column"><?php
                        ...
                        foreach( $menu_bg_settings as $menubgsetting):?>
                          <div class="bpanel-option-set">
                            <label><?php echo $menubgsetting['label'];?></label>
                            <div class="clear"></div>
                            <select name="<?php echo $menubgsetting['name'];?>">
                              <option value=""><?php _e("Select",'dt_themes');?></option><?php 
                                foreach($menubgsetting['options'] as $option):?>
                                  <option value="<?php echo $option;?>" <?php selected($option,dttheme_option('appearance',$menubgsetting['db-key'])); ?>><?php echo $option;?></option><?php
                                endforeach;?>
                            </select>
                            <p class="note"> <?php echo $menubgsetting['tooltip'];?>  </p>
                            <div class="hr_invisible"> </div>
                          </div><?php
                        endforeach;?>
                      </div>  
